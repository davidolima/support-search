...
from siamese_network import TripletLossEuclideanDistance
from siamese_network import TripletLossCosineSimilarity
...
siamese_network = SiameseNetwork(backbone_network, distance_function=nn.CosineSimilarity(dim=1)).to(device)

triplet_loss = TripletLossEuclideanDistance(margin=1.0)
...
torch.save(siamese_network.state_dict(), 'siamese/siamese_MNIST_v2_0.5.pth')
